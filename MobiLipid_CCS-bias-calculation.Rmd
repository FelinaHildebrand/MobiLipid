...
As output the user gets a HTML file and a PDF file containing the gernerated data as well as a CSV file containing the calculated CCS bias (starting with: "CCS_bias_no_correction").'
---
