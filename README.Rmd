...
Additionally, a .RData file is saved storing all results as a list which can be opend within R studio using (`readRDS()`) and the following .csv files are generated:
