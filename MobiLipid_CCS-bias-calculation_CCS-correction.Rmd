...
results <- list()
report_bias <- report_bias[,c("File", "LipidClass", "LipidSpecies", "Polarity", "Adduct", "Label", "Formula", "IMS_value", "CCS", "U13C_DTCCS", "CCS_bias")]
report_bias[,IMS_value := round(IMS_value, digits = 2)]
